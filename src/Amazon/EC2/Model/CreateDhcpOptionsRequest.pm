...
use base qw (Amazon::EC2::Model);
    ...
    sub new {
        ...
        $self->{_fields} = {
            ...
            Configuration => {FieldValue => undef, FieldType => "Amazon::EC2::Model::DhcpConfiguration"},
        };
    ...
    sub setConfiguration {
        my ($self, $value) = @_;
        $self->{_fields}->{Configuration}->{FieldValue} = $value;
    }
    ...
    sub isSetConfiguration {
        return defined (shift->{_fields}->{Configuration}->{FieldValue});
