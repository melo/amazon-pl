      ...
      eval {
              my $response = $service->attachVpnGateway($request);
                ...
                if ($response->isSetAttachVpnGatewayResult()) { 
                    ...
                    if ($attachVpnGatewayResult->isSetVpcAttachement()) { 
                        print("                VpcAttachement\n");
                        my $vpcAttachement = $attachVpnGatewayResult->getVpcAttachement();
                        if ($vpcAttachement->isSetVpcId()) 
                        {
                            print("                    VpcId\n");
                            print("                        " . $vpcAttachement->getVpcId() . "\n");
                        }
                        if ($vpcAttachement->isSetVpcAttachmentState()) 
                        {
                            print("                    VpcAttachmentState\n");
                            print("                        " . $vpcAttachement->getVpcAttachmentState() . "\n");
                        }
                    } 
                } 
